...
/////////////////////////////////////////////////////////////////////////////
//
// base_cthread.cpp - ::THREAD::CThread class source
//
/////////////////////////////////////////////////////////////////////////////
...
void CThread::__construct(T_BOOLEAN bRunning) {
  if (bRunning == true) {
    ...
    if (pbase_attr_init(&m_tAttribute) != 0) {
    ...
    if (pbase_attr_setdetachstate(&m_tAttribute, PTHREAD_CREATE_JOINABLE) != 0) {
      EXCEPTION(THREAD, ::THREAD::CThread, __construct,
    ...
    // create a new thread
    if (pbase_create(&m_tThread, &m_tAttribute, STATIC_Execute, this) != 0) {
...
void CThread::__destruct() {
  if (m_bRunning == true) {
    ...
    // join thread
    if (pbase_join(m_tThread, NULL) != 0) {
...
#error unsupported platform
    ...
    pbase_attr_destroy(&m_tAttribute);
